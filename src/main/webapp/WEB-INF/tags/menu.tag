...
<div id="wb_ResponsiveMenu1" style="position:absolute;left:0px;top:187px;width:1000px;height:70px;z-index:30;">
    ...
    <ul class="ResponsiveMenu1" id="ResponsiveMenu1">
        <li><a href="<c:url value="${home_action}"></c:url>"><i class="fa fa-university fa-2x">&nbsp;</i><br>Home</a></li>
        <li>
            ...
            <ul>
                <li><a href="<c:url value="${products_catalog}"></c:url>"><i class="fa fa-cubes fa-2x">&nbsp;</i>Products</a></li>
