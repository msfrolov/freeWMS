...
public class Validator {
    public static final String LETTERS_DIGITS_WS = "^[а-яА-ЯёЁa-zA-Z 0-9]+$";
    public static final String LETTERS_DIGITS_WS_MIN5_MAX32 = "^[а-яА-ЯёЁa-zA-Z 0-9]{5,32}$";
    public static final String LETTERS_DIGITS = "^[а-яА-ЯёЁa-zA-Z0-9]+$";
    public static final String DIGITS = "^[0-9]+$";
    public static final String DIGITS_MIN1_MAX9 = "^[0-9]{1,9}$";
    public static final String LETTERS = "^[а-яА-ЯёЁa-zA-Z]+$";
